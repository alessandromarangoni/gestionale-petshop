...
<body>
<% Animale animale =(Animale) session.getAttribute("animale");
%>
    ...
    <div class="vh-100 filter">
        <nav class="navbar bg-warning">
          ...
          <main class=" pt-2 mt-5">
            ...
            <form action="./UpdateAnimal" method="POST" class="rounded-5" id="form">
                <div class="d-flex flex-column h-100 px-5 py-4 rounded-5 justify-content-around border border-3 border-warning">
                    ...
                    <div class="row">
                        <div class="col pt-2">
                            ...
                            <input type="text" class="form-control rounded-5 border border-1 border-warning rounded-5 border border-1 border-warning" value="<%= animale.getTipoAnimale() %>" name="tipo-animale" id="tipo-animale">
                          </div>
                          <div class="col pt-2">
                            <input type="number" step=".01" class="form-control rounded-5 border border-1 border-warning" value="<%=animale.getPrezzo() %>" name="prezzo" id="prezzo">
                        </div>
                    </div>
                    
                    <div class="pt-3">
                        <input type="text" class="form-control rounded-5 border border-1 border-warning" name="nome-animale" id="nome-animale" value="<%=animale.getNomeAnimale() %>">
                    </div>
